...
END
/***
EXEC adw.z_CreateUHCMembers '2020-01-01','2021-05-31','2021-06-03'

SELECT * FROM dbo.z_tmp_AttribMembers			WHERE	ClientKey IN (1) AND EffectiveAsOfDate		= '2021-06-03' 
SELECT * FROM dbo.z_tmp_AttribMembers_Failed WHERE	ClientKey IN (1) AND EffectiveAsOfDate		= '2021-06-03' 
...
DECLARE @EffectiveAsOfDate DATE = '2021-06-03'
...
FROM dbo.z_tmp_AttribMembers WHERE ClientKey = 1
	AND convert(date,CreateDate) = @EffectiveAsOfDate
