...
CREATE VIEW [dbo].[vw_ACE_Validation_Chk_UHC_Account_TIN]
AS
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_ACE_Validation_Chk_UHC_Account_TIN';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_ACE_Validation_Chk_UHC_Account_TIN';
