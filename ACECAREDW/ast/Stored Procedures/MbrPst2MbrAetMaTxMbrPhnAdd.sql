CREATE PROCEDURE [ast].[MbrPst2MbrAetMaTxMbrPhnAdd] --  [ast].[MbrPst2MbrAetMaTxMbrPhnAdd]'2021-05-20',3
    (@loadDate DATE    
...
AS	
    ...
    USING(SELECT DISTINCT mf.ClientMemberKey, m.SrcFileName, mf.LoadDate, m.DataDate
	   	   ...
	   	   FROM adi.mbrAetMaTx m
		  	  ...
		  	  ON m.[Line_of_Business] = PlanProduct.SourceValue  
	   	       ...
	   	       JOIN (SELECT pr.AttribTIN, pr.NPI
	   	   	   ...
	   	   	   ON m.Attributed_Provider_Tax_ID_Number_TIN = vp.AttribTIN 	   
		  ) src
