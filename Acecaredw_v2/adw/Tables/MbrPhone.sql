...
GO
CREATE NONCLUSTERED INDEX [Ndx_MbrPhone_EffDateExpDate]
    ON [adw].[MbrPhone]([EffectiveDate] ASC, [ExpirationDate] ASC)
    INCLUDE([mbrPhoneKey], [mbrMemberKey], [PhoneType], [PhoneNumber]);
