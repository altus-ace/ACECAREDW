CREATE PROCEDURE [adw].[PdwUhcMembers_UhcModel]
AS 
BEGIN 
	   ...
	   INSERT INTO [dbo].[Uhc_MembersByPcp](
        ...
        SELECT 
		    a.MEMB_FIRST_NAME
    		  ...
    		  , a.MEDICARE_NO
    		  , a.AGE
    		  , CONVERT(DATE,CONVERT(VARCHAR(9),a.DATE_OF_BIRTH,102)) AS DATE_OF_BIRTH
    		  , a.MEMB_GENDER
    		  , '' AS	MEMB_LANGUAGE
			  ...
			  , CONVERT(DATE,CONVERT(VARCHAR(9),a.MBR_EFFECTIVE_DATE,102)) AS CONT_EFFECTIVE_DATE
			  , CONVERT(DATE,CONVERT(VARCHAR(9),a.MBR_EFFECTIVE_DATE,102)) AS CURRENT_EFFECTIVE_DATE
    		  , a.PROVIDER_NPI
    		  , a.PROV_FNAME
    		  , a.PROV_LNAME
    		  , a.PROV_PHONE
