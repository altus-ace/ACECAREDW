...
END
/***
EXEC adw.z_CreateBCBSMembers '2020-1-01','2021-04-30','2021-05-03'

SELECT * delete FROM dbo.z_tmp_AttribMembers			WHERE	ClientKey IN (20) AND Convert(date,CreateDate)	= '2021-05-03'
SELECT * FROM dbo.z_tmp_AttribMembers_Failed WHERE	ClientKey IN (20)	AND EffectiveAsOfDate			= '2021-05-03'

SELECT * FROM ACECAREDW.adw.tvf_AllClient_ProviderRoster_DevPR_ByClient (20)
