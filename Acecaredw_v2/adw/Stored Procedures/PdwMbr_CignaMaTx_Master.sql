...
AS 
    ...
    /* Load Stging tables */	
   EXEC ast.MbrPst2MbrCignaMaTxMbrDetail @LoadDate, @InsertCount = @Stg2CountMbrDet	OUTPUT; 
   EXEC ast.MbrPst2MbrCignaMaTxMbrPhnAdd @LoadDate, @InsertCount = @Stg2CountMbrPhnAdd OUTPUT;
   ...
   EXECUTE [ast].[pls_AetnaMbrMembershipRunMPI]@ClientKey;
    ...
    /*
    SELECT * FROM ast.MbrStg2_MbrData md where md.ClientKey = 12 and loaddate = '10/05/2020'
    SELECT * FROM ast.MbrStg2_PhoneAddEmail mp WHERE mp.ClientKey = 12
    */
