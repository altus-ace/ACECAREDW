...
AS 
    ...
    FROM (SELECT DISTINCT 
			...
			, AceMetaData.adi.udf_GetCleanString(ISNULL(PrimaryPracticeZipCode.pod__c, ' ')) AS 'PrimaryQuadrant'
	          , AceMetaData.adi.udf_GetCleanString(ISNULL(PrimaryPracticeLocation.Phone__c, ' ')) AS 'PrimaryAddressPhoneNumber'
	          ...
	          , AceMetaData.adi.udf_GetCleanString(ISNULL(BillingPracticeLocation.Phone__c, ' ')) AS 'BillingAddressPhoneNumber'
