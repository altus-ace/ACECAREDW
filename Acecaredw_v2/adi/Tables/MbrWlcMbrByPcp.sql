CREATE TABLE [adi].[MbrWlcMbrByPcp] (
    ...
    [InQuarantine]      TINYINT       CONSTRAINT [DF_adiWlcMbrUhcMbrByPcp_InQuarantine] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [Ck_adiWlcMbrUhcMbrByPcp_InQuarantine] CHECK ([InQuarantine]=(1) OR [InQuarantine]=(0)),
    CONSTRAINT [Ck_astWlcMbrUhcMbrSmry_InQuarantine] CHECK ([InQuarantine]=(1) OR [InQuarantine]=(0))
);
