...
GO
CREATE NONCLUSTERED INDEX [ndx_AdiMbrAetCom_EffDateMbrIDPulsScore]
    ON [adi].[MbrAetCom]([EffectiveMonth] ASC)
    INCLUDE([MEMBER_ID], [Pulse_score_Point_in_time]);


GO
CREATE NONCLUSTERED INDEX [ndx_MbrAetCom_EffMonthMbrId]
    ON [adi].[MbrAetCom]([EffectiveMonth] ASC, [MEMBER_ID] ASC);
